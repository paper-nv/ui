...
import ProfileModal from "../../components/modals/ProfileModalCustom";
import DeleteProfileModal from "../../components/modals/deleteProfileModalCustom";
...
const Customer = () => {
  ...
  useEffect(() => {
    isLoading
      ? appServices.customerList(options || "page=1&limit=10").then((res) => {
